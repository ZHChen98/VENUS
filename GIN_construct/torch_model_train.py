...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if (index >= len(self.labels) or index < 0):
            print(index)
...
class BERTClass(torch.nn.Module):
    def __init__(self):
        ...
        config = BertConfig.from_pretrained("./PubMedBERT-base-uncased-abstract-fulltext", num_labels=len(list(tag2idx.keys())))
        self.l1 = BertForTokenClassification.from_pretrained('./PubMedBERT-base-uncased-abstract-fulltext', config=config)
